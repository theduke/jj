...
pub fn cmd_bookmark_rename(
    ...
    let view = workspace_command.repo().view();
    if has_tracked_remote_bookmarkes(view, old_bookmark) {
        writeln!(
            ui.warning_default(),
            "Tracked remote bookmarkes for bookmark {old_bookmark} were not renamed.",
        )?;
        writeln!(
            ui.hint_default(),
    ...
    if has_tracked_remote_bookmarkes(view, new_bookmark) {
        ...
        writeln!(
            ui.warning_default(),
            "Tracked remote bookmarkes for bookmark {new_bookmark} exist."
        )?;
        writeln!(
            ui.hint_default(),
