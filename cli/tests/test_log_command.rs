...
fn test_multiple_revsets() {
    ...
    insta::assert_snapshot!(
        test_env.jj_cmd_success(&repo_path, &["log", "-T", "bookmarkes", "-rfoo"]),
        @r###"
    ○  foo
    │
    ~
    "###);
    insta::assert_snapshot!(
        test_env.jj_cmd_success(&repo_path, &["log", "-T", "bookmarkes", "-rfoo", "-rbar", "-rbaz"]),
        @r###"
    @  baz
    ○  bar
    ○  foo
    ...
    "###);
    insta::assert_snapshot!(
        test_env.jj_cmd_success(&repo_path, &["log", "-T", "bookmarkes", "-rfoo", "-rfoo"]),
        @r###"
    ○  foo
    │
    ~
