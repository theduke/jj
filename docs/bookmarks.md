...
Git's remote-tracking bookmarks). This record is updated on every `jj git fetch`
...
"upstream bookmark". Unlike Git, a single local bookmark can be tracking remote
...
[design]: design/tracking-bookmarks.md
